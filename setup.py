...
setup(
    ...
    description="GitLab admin Helper",  # Optional
    ...
    install_requires=[
        ...
        "h2==3.2.0",
        "hpack==3.0.0",
        "hstspreload==2020.9.2; python_version >= '3.6'",
        "httpcore==0.9.1; python_version >= '3.6'",
        "httpx==0.13.3; python_version >= '3.6'",
        "hyperframe==5.2.0",
        "idna==2.10; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2, 3.3'",
        "isort==5.4.2; python_version >= '3.6' and python_version < '4'",
    ...
    entry_points={"console_scripts": ["gitlab-admin=gitlab_admin.api:main"]},  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://collaborating.tuhh.de/rzt/projects/gitlab-admin/-/issues",
        "Funding": "",
        "Say Thanks!": "RZT TU Hamburg",
        "Source": "https://collaborating.tuhh.de/rzt/projects/gitlab-admin/",
    },
)
