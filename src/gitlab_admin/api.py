...
def main():
    ...
    parser_spl = subparsers.add_parser('spl', help="Set the project limit of all accounts to a concrete value if the current value is smaller.")
    parser_spl.add_argument('--nono', action='store_true', help='Do not make any changes')
    parser_spl.add_argument('-l', '--limit', required=True, type=int, help='set project limit')
